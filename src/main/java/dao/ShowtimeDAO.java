...
public class ShowtimeDAO {
    ...
    public boolean addShowtime(Showtime showtime) {
        String query = "INSERT INTO Showtimes (movie_id, room_id, start_time, end_time, ticket_price) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean updateShowtime(Showtime showtime) {
        String query = "UPDATE Showtimes SET movie_id = ?, room_id = ?, start_time = ?, end_time = ?, ticket_price = ? WHERE showtime_id = ?";
