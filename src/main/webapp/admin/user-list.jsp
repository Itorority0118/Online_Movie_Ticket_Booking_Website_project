...
<div class="table-wrapper">
	...
	<form method="get" action="${pageContext.request.contextPath}/user"
		...
		<input type="hidden" name="action" value="list" /> <input type="text"
			name="search" placeholder="Search..." value="${param.search}" />

		<div class="filter-group">
			<label> <input type="checkbox" name="role" value="admin"
				<c:if test="${param.role == 'admin'}">checked</c:if> /> Admin
			</label> <label> <input type="checkbox" name="role" value="user"
		...
		<div class="filter-group">
			...
			</label> <label> <input type="checkbox" name="status"
				value="inactive"
