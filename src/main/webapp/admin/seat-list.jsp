...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/room/room-form.css?v=4">
...
<script src="${pageContext.request.contextPath}/js/seat/seat-list.js?v=5" defer></script>